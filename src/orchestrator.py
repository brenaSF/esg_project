...
class ESGAutomationOrchestrator:
    def __init__(self, pdf_path, empresa, ano, config_esg):
        ...
        self.dir_output = "data/output"
        self.dir_csv = os.path.join(self.dir_output, "resultado_csv")
    ...
    def run_pipeline(self):
        ...
        # 3. Transformação e Mineração (Vector Indexing + RAG)
        ...
        # 4. Exportação (Evaluation do KDD)
